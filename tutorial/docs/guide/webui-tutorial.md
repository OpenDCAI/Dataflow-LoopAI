...
![资源池管理入口](/images/webui/s4.1.png)

![资源池中的路径类资源配置](/images/webui/s4.2.png)
...
![任务面板中的新任务创建与启动](/images/webui/s5.1.png)

![节点出现状态字段后表示启动成功](/images/webui/S5.2.png)
...
![通过对话进入 Configer 并补充参数](/images/webui/s6.1.png)
...
![看到 confirm true 才表示配置真正写入成功](/images/webui/s6.2.png)

![通过 next_to 和节点亮光判断当前 Agent](/images/webui/s6.3.png)
...
![缺参数时自动跳转到 Configer 补全并返回原节点](/images/webui/s6.4.png)
...
![缺参数时自动跳转到 Configer 补全并返回原节点](/images/webui/s6.5.png)
...
![Custom Info 与 States 的观察位置](/images/webui/s7.png)
