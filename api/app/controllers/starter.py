...
async def starter_codex_session_looper(session_id: str, req: StarterLooperRequest | None = None):
    return await run_looper_for_session(session_id, req)


@router.post("/codex/session/{session_id}/looper/terminate", operation_id="starterCodexSessionLooperTerminate", summary="Terminate running looper")
async def starter_codex_session_looper_terminate(session_id: str):
    return await terminate_looper_for_session(session_id)
